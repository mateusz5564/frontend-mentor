...
function generateJobHtml(data) {
  ...
  <div>
    <div class="job__header">
      ...
      ${data.new ? '<span class="job__label job__label--dark">Featured</span>' : ''}
    </div>
